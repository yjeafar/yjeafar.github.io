  ...
  return (
    ...
    <Box m={1} className="projectBorder">
      <p>
        ...
        and made it into a powerful server with many terabytes of storage (Raid 1 setup). I use Proxmox OS, have docker containers running Nextcloud and Jellyfin. I also
